<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Navbar.ascx.cs" Inherits="COMP2007_S2016_Lesson6A.Navbar" %>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <asp:PlaceHolder ID="PrivatePlaceHolder" runat="server">
                    <li id="main" runat="server"><a href="MainMenu.aspx"><i class="fa fa-map-signs fa-lg"></i> Main Menu</a></li>
